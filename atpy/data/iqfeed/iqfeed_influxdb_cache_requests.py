...
class IQFeedInfluxDBOHLCRequest(InfluxDBOHLCRequest):
    ...
    def request(self, interval_len: int, interval_type: str = 's', symbol: typing.Union[list, str] = None, bgn_prd: datetime.datetime = None, end_prd: datetime.datetime = None, ascending: bool = True, adjust_data=True):
        result = super().request(interval_len=interval_len, interval_type=interval_type, symbol=symbol, bgn_prd=bgn_prd, end_prd=end_prd)
