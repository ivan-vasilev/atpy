...
class IQFeedInfluxDBCache(InfluxDBCache):
    ...
    def __init__(self, client: DataFrameClient, history: IQFeedHistoryProvider=None, use_stream_events=True, time_delta_back: relativedelta = relativedelta(years=5), default_timezone: str = 'US/Eastern', adjust=True):
    ...
    def _request_noncache_data(self, filters, q):
        ...
        self.history.request_data_by_filters(new_filters, q, adjust_data=self.adjust)
